...
| POST | `/:id/copiar-desde-compartido` | **copia** un archivo de **otra carpeta compartida** a esta `{archivoId, carpeta?}` (el original permanece). Dedup por hash, duplica binario y fragmentos RAG. Usado por "Copiar en… › [otra carpeta]" |
